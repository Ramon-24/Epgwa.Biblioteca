            ...
            <section className="area-d">
                ...
                <div className='guia'>
                    ...
                    <div className='guia-principal'>
                        <svg onClick={()=>navigate('/atraso')} xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="clocks" viewBox="0 0 16 16"><path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71z"/><path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0"/></svg>
                    </div>
                ...
                <main>
                    <h1 className='config'>Atrasou a entrega com a Ep Biblioteca</h1>
                    <header className="min-caixa">
                            <div className="min-dados">
                                <div className='livro-fantasma'>
                                    <h2>Livro que esta com o aluno</h2>
                                    <h2>Autor do livro</h2>
                                </div>
                                <div>
                                    <h1>Ramon Gomes Brandão Silva</h1>
                                    <h2>2 Desenvolvimento de Sistemas</h2>
                                </div>
                            </div>
                            <div className="min-dados">
                                <div className='livro-fantasma'>
